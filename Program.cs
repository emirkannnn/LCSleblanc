...
namespace LCSleblanc
{
    internal class Program
    {
        private static readonly List<Leblanc.Slide> ExistingSlide = new List<Leblanc.Slide>(); public static Spell.Targeted Q, R; public static Spell.Skillshot W, E; private static ComboType vComboType = ComboType.ComboQR; private static ComboKill vComboKill = ComboKill.FullCombo; private static bool _isComboCompleted = true;
        ...
        public static Menu LeblancMenu, ComboMenu, HarassMenu, KillStealMenu, Flee, ExtraMenu, DrawinMenu;
        ...
        public static Menu ExtrasMenu { get; private set; }
        ...
        private static void Combo()
        {
            ...
            if (R.IsReady())
            {
                ...
                else
                {
                    ...
                    if (ObjectManager.Player.Spellbook.GetSpell(SpellSlot.R).Name == "LeblancSoulShackleM")
                    {
        ...
        private static void ExecuteCombo()
        {
            ...
            var cdQ = Game.Time < cdQEx ? cdQEx - Game.Time : 4;
            var cdW = Game.Time < cdWEx ? cdWEx - Game.Time : 4;
            var cdE = Game.Time < cdEEx ? cdEEx - Game.Time : 4;
        ...
        public static class Config
        {
            ...
            {
                get { return Flee["RunUseW"].Cast<CheckBox>().CurrentValue; }
            }

            public static bool RunUseR
            {
                get { return Flee["RunUseR"].Cast<CheckBox>().CurrentValue; }
            }

            public static bool ExtrasInterruptSpells
            {
                get { return ExtraMenu["interruptspells"].Cast<CheckBox>().CurrentValue; }
            }

            public static bool DrawQ
            {
                get { return DrawinMenu["drawq"].Cast<CheckBox>().CurrentValue; }
            }

            public static bool DrawW
            {
                get { return DrawinMenu["draww"].Cast<CheckBox>().CurrentValue; }
            }

            public static bool DrawE
            {
                get { return DrawinMenu["drawe"].Cast<CheckBox>().CurrentValue; }
            }
            ...
            {
                get { return DrawinMenu["ObjTimeTick"].Cast<CheckBox>().CurrentValue; }
            }

            public static bool DrawActiveERange
            {
                get { return DrawinMenu["activeerange"].Cast<CheckBox>().CurrentValue; }
            }

            public static bool DrawWplusQRange
            {
                get { return DrawinMenu["wqrange"].Cast<CheckBox>().CurrentValue; }
            }

            public static bool DrawDamageBarIndicator
            {
                get { return DrawinMenu["drawdamagebar"].Cast<CheckBox>().CurrentValue; }
            }
